...
<div className="relative mx-auto mb-4 h-40 w-40 lg:hidden">
  <Image
  ...
  />
            ...
            <p className="mx-auto mt-3 max-w-2xl text-lusso-charcoal/80">
              No te vendemos un paquete y desaparecemos. Nuestro equipo te
              asesora de forma personalizada antes, durante y después de tu
              viaje.
            </p>
          </div>
        </RevealOnScroll>
