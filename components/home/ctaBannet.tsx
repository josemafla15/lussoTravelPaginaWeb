  ...
  return (
    <section
      className={`relative overflow-hidden ${
        color === "blue" ? "bg-lusso-blue py-16" : "bg-lusso-sage py-16"
      }`}
    >
      {/* Churito decorativo — lado izquierdo */}
<div className="pointer-events-none absolute left-3.5 top-1.2 hidden h-200 w-200 -translate-y-1/2 lg:block">
  <Image
    src="/images/formas/churito.png"
    alt=""
    fill
